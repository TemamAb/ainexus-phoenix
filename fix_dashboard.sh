...
echo "Ì∫Ä FIXING AI-NEXUS DASHBOARD - Serving HTML at Root URL"
...
def start_deployment():
    try:
        ...
        logger.info("Ì∫Ä AI-NEXUS Deployment Started")
...
echo "‚úÖ Fixed app.py created"

# Push the fix to GitHub and trigger Render rebuild
git add .
git commit -m "Ì∫Ä FIX: Serve HTML dashboard at root URL" || echo "No changes to commit"
git push origin main

echo "ÌæØ Fix deployed! Render will auto-rebuild in 2-3 minutes."
echo "Ì¥ç Check build status: https://dashboard.render.com -> ainexus-phoenix-live -> Deploys"
echo "Ìºê After rebuild, visit: https://ainexus-phoenix-live.onrender.com"
